...
export class Constraint {
  ...
  static _wrap(inner: any): Constraint {
    if (!inner) return null as unknown as Constraint;
  ...
  get active(): boolean {
    return this._inner.get_active();
  }
  set active(value: boolean) {
    this._inner.set_active(value);
  }
  ...
  get stiff(): boolean {
    return this._inner.get_stiff();
  }
  set stiff(value: boolean) {
    this._inner.set_stiff(value);
  }

  get frequency(): number {
    return this._inner.get_frequency();
  }
  set frequency(value: number) {
    this._inner.set_frequency(value);
  }

  get damping(): number {
    return this._inner.get_damping();
  }
  set damping(value: number) {
    this._inner.set_damping(value);
  }

  get maxForce(): number {
    return this._inner.get_maxForce();
  }
  set maxForce(value: number) {
    this._inner.set_maxForce(value);
  }

  get maxError(): number {
    return this._inner.get_maxError();
  }
  set maxError(value: number) {
    this._inner.set_maxError(value);
  }

  get breakUnderForce(): boolean {
    return this._inner.get_breakUnderForce();
  }
  set breakUnderForce(value: boolean) {
    this._inner.set_breakUnderForce(value);
  }

  get breakUnderError(): boolean {
    return this._inner.get_breakUnderError();
  }
  set breakUnderError(value: boolean) {
    this._inner.set_breakUnderError(value);
  }

  get removeOnBreak(): boolean {
    return this._inner.get_removeOnBreak();
  }
  set removeOnBreak(value: boolean) {
    this._inner.set_removeOnBreak(value);
  }
  ...
  impulse(): any {
    return this._inner.impulse();
  }

  bodyImpulse(body: Body): any {
    return this._inner.bodyImpulse(body._inner);
  }
  ...
  copy(): Constraint {
    return Constraint._wrap(this._inner.copy());
  }
