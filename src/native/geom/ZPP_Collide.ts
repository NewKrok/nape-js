      ...
      if (
        ...
        if (s1.type == 0) {
          ...
          while (cx_ite1 != null) {
            const a = cx_ite1.elt;
            if (
              a.gnormx * s2.circle.worldCOMx +
                a.gnormy * s2.circle.worldCOMy +
                s2.circle.radius <=
              a.gprojection
            ) {
          ...
          if (cont1) {
            ...
            if (dt <= v0.y * a0.gnormx - v0.x * a0.gnormy) {
              ...
              if (co != null) {
                ...
                if (rev) {
                  con1.lr1x =
                    vx * s2.polygon.body.axisy + vy * s2.polygon.body.axisx;
                  con1.lr1y =
                    vy * s2.polygon.body.axisy - vx * s2.polygon.body.axisx;
              ...
              if (distSqr1 > minDist1 * minDist1) {
                ...
                const dist2 =
                  invDist1 < napeNs.Config.epsilon ? 1e100 : 1.0 / invDist1;
              ...
              if (co1 != null) {
                ...
                if (rev) {
                  con2.lr1x =
                    vx1 * s2.polygon.body.axisy + vy1 * s2.polygon.body.axisx;
                  con2.lr1y =
                    vy1 * s2.polygon.body.axisy - vx1 * s2.polygon.body.axisx;
      ...
      if (s2.type == 1) {
        if (s1.type == 1) {
                ...
                while (cx_itej != null) {
                  ...
                  while (cx_itej1 != null) {
                    ...
                    if (den * den > napeNs.Config.epsilon * napeNs.Config.epsilon) {
                      ...
                      if (
                        txx > napeNs.Config.epsilon &&
                        txx < 1 - napeNs.Config.epsilon
                      ) {
                        const sxx = (_vy * _sx - _vx * _sy) * den;
                        if (
                          sxx > napeNs.Config.epsilon &&
                          sxx < 1 - napeNs.Config.epsilon
                        ) {
                          t6 = txx;
                          tmp = true;
                        } else {
                  ...
                  if (cx_cont1) {
                    while (true) {
                      ...
                      if (
                        ...
                        if (
                          txx1 > napeNs.Config.epsilon &&
                          txx1 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx1 = (_vy1 * _sx1 - _vx1 * _sy1) * den1;
                          if (
                            sxx1 > napeNs.Config.epsilon &&
                            sxx1 < 1 - napeNs.Config.epsilon
                          ) {
                            t7 = txx1;
                            tmp1 = true;
                          } else {
                  ...
                  while (true) {
                    ...
                    while (cx_itej2 != null) {
                      ...
                      if (
                        ...
                        if (
                          txx2 > napeNs.Config.epsilon &&
                          txx2 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx2 = (_vy2 * _sx2 - _vx2 * _sy2) * den2;
                          if (
                            sxx2 > napeNs.Config.epsilon &&
                            sxx2 < 1 - napeNs.Config.epsilon
                          ) {
                            t8 = txx2;
                            tmp2 = true;
                          } else {
                    ...
                    if (cx_cont2) {
                      while (true) {
                        ...
                        if (
                          ...
                          if (
                            txx3 > napeNs.Config.epsilon &&
                            txx3 < 1 - napeNs.Config.epsilon
                          ) {
                            const sxx3 = (_vy3 * _sx3 - _vx3 * _sy3) * den3;
                            if (
                              sxx3 > napeNs.Config.epsilon &&
                              sxx3 < 1 - napeNs.Config.epsilon
                            ) {
                              t9 = txx3;
                              tmp3 = true;
                            } else {
                  ...
                  if (!out1[ind11]) {
                    ...
                    while (true) {
                      ...
                      if (
                        ...
                        if (
                          txx4 > napeNs.Config.epsilon &&
                          txx4 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx4 = (_vy4 * _sx4 - _vx4 * _sy4) * den4;
                          if (
                            sxx4 > napeNs.Config.epsilon &&
                            sxx4 < 1 - napeNs.Config.epsilon
                          ) {
                            t10 = txx4;
                            tmp5 = true;
                          } else {
                    ...
                    while (cx_ite6 != beg_ite) {
                      ...
                      if (
                        ...
                        if (
                          txx5 > napeNs.Config.epsilon &&
                          txx5 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx5 = (_vy5 * _sx5 - _vx5 * _sy5) * den5;
                          if (
                            sxx5 > napeNs.Config.epsilon &&
                            sxx5 < 1 - napeNs.Config.epsilon
                          ) {
                            t11 = txx5;
                            tmp6 = true;
                          } else {
                  ...
                  if (!out2[ind2]) {
                    ...
                    while (true) {
                      ...
                      if (
                        ...
                        if (
                          txx6 > napeNs.Config.epsilon &&
                          txx6 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx6 = (_vy6 * _sx6 - _vx6 * _sy6) * den6;
                          if (
                            sxx6 > napeNs.Config.epsilon &&
                            sxx6 < 1 - napeNs.Config.epsilon
                          ) {
                            t12 = txx6;
                            tmp10 = true;
                          } else {
                    ...
                    while (cx_ite7 != beg_ite1) {
                      ...
                      if (
                        ...
                        if (
                          txx7 > napeNs.Config.epsilon &&
                          txx7 < 1 - napeNs.Config.epsilon
                        ) {
                          const sxx7 = (_vy7 * _sx7 - _vx7 * _sy7) * den7;
                          if (
                            sxx7 > napeNs.Config.epsilon &&
                            sxx7 < 1 - napeNs.Config.epsilon
                          ) {
                            t13 = txx7;
                            tmp11 = true;
                          } else {
          ...
          while (cx_ite9 != null) {
            ...
            let dist =
              a4.gnormx * s1.circle.worldCOMx + a4.gnormy * s1.circle.worldCOMy;
            if (dist > a4.gprojection + s1.circle.radius) {
              cont1 = false;
              break;
            } else if (
              dist + s1.circle.radius >
              a4.gprojection + napeNs.Config.epsilon
            ) {
              total1 = false;
              inte[ind3] = true;
            }
                ...
                if (total2) {
                  ...
                  while (state != 0)
                    if (state == 1) {
                      ...
                      if (ins[vind]) {
                        ...
                        const C =
                          qx * qx + qy * qy - s1.circle.radius * s1.circle.radius;
                      ...
                      while (true) {
                        ...
                        if (inte[vind]) {
                          if (ins[vind2]) {
                            ...
                            const t19 = (-B1 - D1) * A1;
                            const tval1 =
                              t19 < napeNs.Config.epsilon ? (-B1 + D1) * A1 : t19;
                            let cx5 = 0.0;
                            let cy5 = 0.0;
                            const T5 = tval1;
                            ...
                            ret5.y = cy5;
                            const cp = ret5;
                            ZPP_Collide.flowsegs.add(
                              ZPP_Collide.flowpoly.head.elt
                            );
                            ...
                            if (
                              t0 < 1 - napeNs.Config.epsilon &&
                              t110 > napeNs.Config.epsilon
                            ) {
                              let cx6 = 0.0;
                              let cy6 = 0.0;
                              const T6 = t0;
                      ...
                      while (cx_ite12 != beg_ite2) {
                        ...
                        if (inte[vind]) {
                          if (ins[vind21]) {
                            ...
                            const t20 = (-B3 - D3) * A3;
                            const tval2 =
                              t20 < napeNs.Config.epsilon ? (-B3 + D3) * A3 : t20;
                            let cx8 = 0.0;
                            let cy8 = 0.0;
                            const T8 = tval2;
                            ...
                            if (
                              t01 < 1 - napeNs.Config.epsilon &&
                              t111 > napeNs.Config.epsilon
                            ) {
                              let cx9 = 0.0;
                              let cy9 = 0.0;
                              const T9 = t01;
                  ...
                  if (ZPP_Collide.flowpoly.head == null) {
                    ...
                    while (cx_ite13 != null) {
                      ...
                      const dist2 =
                        e.gnormx * s1.circle.worldCOMx +
                        e.gnormy * s1.circle.worldCOMy;
                    ...
                    if (
                      ...
                      ZPP_Collide.flowsegs.add(
                        ZPP_Collide.flowpoly.head.next.elt
                      );
                    }
                    while (ZPP_Collide.flowsegs.head != null) {
                      ...
                      carea =
                        s1.circle.radius * (s1.circle.radius * theta - X * sin);
                      ccom =
                        (0.66666666666666663 *
                          s1.circle.radius *
                          sin *
        ...
        if (ds > cr * cr) {
          ...
          const id = 1 / d1;
          const x1 =
            0.5 * (d1 - (c2.radius * c2.radius - c1.radius * c1.radius) * id);
          if (x1 <= -c1.radius) {
            arb.overlap = c1.area;
            arb.centroidx = c1.worldCOMx;
            arb.centroidy = c1.worldCOMy;
            ...
            if (x2 <= -c2.radius) {
              ...
              y1 =
                (0.66666666666666663 * c1.radius * sin1 * sin1 * sin1) /
                (theta1 - cos1 * sin1);
              const X2 = x2;
              ...
              y2 =
                (0.66666666666666663 * c2.radius * sin2 * sin2 * sin2) /
                (theta2 - cos2 * sin2);
