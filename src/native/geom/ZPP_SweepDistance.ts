    ...
    static dynamicSweep(
      ...
      if (
        ...
        deltax * deltax + deltay * deltay <
          napeNs.Config.dynamicSweepLinearThreshold *
            napeNs.Config.dynamicSweepLinearThreshold &&
      ...
      while (true) {
        ...
        if (s1.type == 0) {
          s1.worldCOMx =
            b1.posx + (b1.axisy * s1.localCOMx - b1.axisx * s1.localCOMy);
          s1.worldCOMy =
            b1.posy + (s1.localCOMx * b1.axisx + s1.localCOMy * b1.axisy);
        } else {
          const p1 = s1.polygon;
          ...
          while (cx_ite1 != null) {
            ...
            e.gprojection =
              b1.posx * e.gnormx + b1.posy * e.gnormy + e.lprojection;
          ...
          e1.gprojection =
            b1.posx * e1.gnormx + b1.posy * e1.gnormy + e1.lprojection;
        ...
        if (s2.type == 0) {
          s2.worldCOMx =
            b2.posx + (b2.axisy * s2.localCOMx - b2.axisx * s2.localCOMy);
          s2.worldCOMy =
            b2.posy + (s2.localCOMx * b2.axisx + s2.localCOMy * b2.axisy);
        } else {
          const p3 = s2.polygon;
          ...
          while (cx_ite3 != null) {
            ...
            e2.gprojection =
              b2.posx * e2.gnormx + b2.posy * e2.gnormy + e2.lprojection;
          ...
          e3.gprojection =
            b2.posx * e3.gnormx + b2.posy * e3.gnormy + e3.lprojection;
        ...
        if (s11.type == 0 && s21.type == 0) {
          ...
          if (s11.type == 1 && s21.type == 0) {
            ...
            if (best < 1e100) {
              ...
              const v11 = a0.gp1;
              const dt2 =
                circle.worldCOMy * a0.gnormx - circle.worldCOMx * a0.gnormy;
        ...
        if (curTOI >= 1) {
          ...
          if (s1.type == 0) {
            ...
            while (cx_ite11 != null) {
              ...
              e4.gprojection =
                b1.posx * e4.gnormx + b1.posy * e4.gnormy + e4.lprojection;
            ...
            e5.gprojection =
              b1.posx * e5.gnormx + b1.posy * e5.gnormy + e5.lprojection;
          ...
          if (s2.type == 0) {
            ...
            while (cx_ite13 != null) {
              ...
              e6.gprojection =
                b2.posx * e6.gnormx + b2.posy * e6.gnormy + e6.lprojection;
            ...
            e7.gprojection =
              b2.posx * e7.gnormx + b2.posy * e7.gnormy + e7.lprojection;
          ...
          if (s13.type == 0 && s23.type == 0) {
            ...
            if (s13.type == 1 && s23.type == 0) {
              ...
              if (best2 < 1e100) {
                ...
                const v13 = a01.gp1;
                const dt5 =
                  circle1.worldCOMy * a01.gnormx - circle1.worldCOMx * a01.gnormy;
              ...
              if (best3 < 1e100) {
                ...
                if (best3 < 1e100) {
                  ...
                  if (best3 >= 0) {
                    ...
                    let t110 =
                      -(vx1 * (v03.x - q01.x) + vy1 * (v03.y - q01.y)) * vdot1;
                    let t210 =
                      -(vx1 * (v03.x - q13.x) + vy1 * (v03.y - q13.y)) * vdot1;
                    let s14 =
                      -(qx1 * (q01.x - v03.x) + qy1 * (q01.y - v03.y)) * qdot1;
                    let s24 =
                      -(qx1 * (q01.x - v15.x) + qy1 * (q01.y - v15.y)) * qdot1;
                    if (t110 < 0) {
                      t110 = 0;
                    } else if (t110 > 1) {
                      t110 = 1;
                    ...
                    const c0d1 =
                      c0x1 * ax1.gnormx + c0y1 * ax1.gnormy - ax1.gprojection;
                    const c1d1 =
                      c1x1 * ax1.gnormx + c1y1 * ax1.gnormy - ax1.gprojection;
                    if (c0d1 < c1d1) {
                      w21.x = c0x1;
                      w21.y = c0y1;
                      const t48 = -c0d1;
        ...
        if (curTOI >= 1) {
          ...
          if (s1.type == 0) {
            ...
            while (cx_ite9 != null) {
              ...
              e3.gprojection =
                b1.posx * e3.gnormx + b1.posy * e3.gnormy + e3.lprojection;
              e3.tp0 = u1.y * e3.gnormx - u1.x * e3.gnormy;
                ...
                if (best3 < 1e100) {
                  ...
                  if (best3 >= 0) {
                    ...
                    let s14 =
                      -(qx1 * (q01.x - v03.x) + qy1 * (q01.y - v03.y)) * qdot1;
                    let s24 =
                      -(qx1 * (q01.x - v14.x) + qy1 * (q01.y - v14.y)) * qdot1;
                    if (t110 < 0) {
                      t110 = 0;
                    } else if (t110 > 1) {
                      t110 = 1;
              ...
              if (best1 < upperBound) {
                ...
                if (best1 < upperBound) {
                  ...
                  if (best1 >= 0) {
                    ...
                    let t13 = -(vx * (v01.x - q0.x) + vy * (v01.y - q0.y)) * vdot;
                    let t21 =
                      -(vx * (v01.x - q11.x) + vy * (v01.y - q11.y)) * vdot;
                    let s12 = -(qx * (q0.x - v01.x) + qy * (q0.y - v01.y)) * qdot;
                    ...
                    const c0d =
                      c0x * ax1.gnormx + c0y * ax1.gnormy - ax1.gprojection;
                    const c1d =
                      c1x * ax1.gnormx + c1y * ax1.gnormy - ax1.gprojection;
                    if (c0d < c1d) {
                      w21.x = c0x;
                      w21.y = c0y;
                      const t24 = -c0d;
