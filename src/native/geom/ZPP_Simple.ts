...
export class ZPP_Simple {
  ...
  static decompose(poly: Any, rets: Any): Any {
    ...
    var _g = 0;
    var _g1 = ZPP_Simple.inthash.table.length;
    while (_g < _g1) {
      var i = _g++;
