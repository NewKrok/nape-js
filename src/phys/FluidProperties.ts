...
export class FluidProperties {
  ...
  get viscosity(): number { return this._inner.get_viscosity(); }
  set viscosity(value: number) { this._inner.set_viscosity(value); }
  ...
  copy(): FluidProperties { return FluidProperties._wrap(this._inner.copy()); }
