...
define(function () {
  ...
  nape.dynamics.ContactIterator = $hxClasses["nape.dynamics.ContactIterator"] =
    function () {
      this.zpp_next = null;
      this.zpp_critical = false;
      this.zpp_i = 0;
      this.zpp_inner = null;
      if (!zpp_nape.util.ZPP_ContactList.internal) {
        throw new js._Boot.HaxeError(
          "Error: Cannot instantiate " + "Contact" + "Iterator derp!"
        );
      }
    };
  nape.dynamics.ContactIterator.__name__ = [
    "nape",
    "dynamics",
    "ContactIterator",
  ];
  ...
  nape.dynamics.ContactIterator.prototype.__class__ =
    nape.dynamics.ContactIterator;
  nape.dynamics.ContactList = $hxClasses["nape.dynamics.ContactList"] =
    function () {
      this.zpp_inner = null;
  ...
  nape.dynamics.ContactList.fromArray = function (array) {
    if (array == null) {
      throw new js._Boot.HaxeError(
        "Error: Cannot convert null Array to Nape list"
      );
    }
  ...
  nape.dynamics.ContactList.prototype.copy = function (deep) {
    ...
    var ret = new nape.dynamics.ContactList();
    this.zpp_inner.valmod();
    var _g = nape.dynamics.ContactIterator.get(this);
    while (true) {
      ...
      if (_g.zpp_i < length) {
        ...
        _g.zpp_next = nape.dynamics.ContactIterator.zpp_pool;
        nape.dynamics.ContactIterator.zpp_pool = _g;
        _g.zpp_inner = null;
        tmp = false;
      }
      if (!tmp) {
      ...
      if (deep) {
        throw new js._Boot.HaxeError(
          "Error: " + "Contact" + " is not a copyable type"
        );
      } else {
        tmp1 = i1;
      }
  ...
  nape.dynamics.ContactList.prototype.merge = function (xs) {
    ...
    xs.zpp_inner.valmod();
    var _g = nape.dynamics.ContactIterator.get(xs);
    while (true) {
      _g.zpp_inner.zpp_inner.valmod();
      var _this = _g.zpp_inner;
      _this.zpp_inner.valmod();
  ...
  nape.dynamics.ContactList.prototype.foreach = function (lambda) {
    if (lambda == null) {
      throw new js._Boot.HaxeError(
        "Error: Cannot execute null on list elements"
      );
    }
    this.zpp_inner.valmod();
    var it = nape.dynamics.ContactIterator.get(this);
    while (true) {
  ...
  nape.dynamics.ContactList.prototype.filter = function (lambda) {
    if (lambda == null) {
      throw new js._Boot.HaxeError(
        "Error: Cannot select elements of list with null"
      );
    }
    var i = 0;
    while (true) {
  ...
  // Registration handled by registerLists.ts at module load time.
  nape.geom.GeomVertexIterator = $hxClasses["nape.geom.GeomVertexIterator"] =
    function () {
      if (!zpp_nape.geom.ZPP_GeomVertexIterator.internal) {
        throw new js._Boot.HaxeError(
          "Error: Cannot instantiate GeomVertexIterator"
        );
      }
    };
  nape.geom.GeomVertexIterator.__name__ = [
    "nape",
    "geom",
    "GeomVertexIterator",
  ];
  ...
  nape.geom.GeomVertexIterator.prototype.hasNext = function () {
    ...
    var ret =
      this.zpp_inner.ptr != this.zpp_inner.start || this.zpp_inner.first;
  ...
  nape.geom.Vec2Iterator = $hxClasses["nape.geom.Vec2Iterator"] = function () {
    ...
    this.zpp_i = 0;
    this.zpp_inner = null;
    if (!zpp_nape.util.ZPP_Vec2List.internal) {
      throw new js._Boot.HaxeError(
        "Error: Cannot instantiate " + "Vec2" + "Iterator derp!"
      );
    }
  };
  ...
  nape.geom.Vec2List.prototype.copy = function (deep) {
    ...
    while (true) {
      ...
      if (_g.zpp_i < length) {
        ...
        _g.zpp_next = nape.geom.Vec2Iterator.zpp_pool;
        nape.geom.Vec2Iterator.zpp_pool = _g;
        _g.zpp_inner = null;
        tmp = false;
      }
      if (!tmp) {
  ...
  nape.phys.Body = $hxClasses["nape.phys.Body"] = function (type, position) {
    ...
    if (type == null) {
      ...
      type1 = zpp_nape.util.ZPP_Flags.BodyType_DYNAMIC;
    } else {
      type1 = type;
    }
    ...
    if (zpp_nape.phys.ZPP_Body.types[this.zpp_inner.type] != type1) {
      if (type1 == null) {
      ...
      if (type1 == zpp_nape.util.ZPP_Flags.BodyType_DYNAMIC) {
        ntype = 2;
      } else {
        ...
        ntype = type1 == zpp_nape.util.ZPP_Flags.BodyType_KINEMATIC ? 3 : 1;
      }
    ...
    this.zpp_inner_i.insert_cbtype(
      zpp_nape.callbacks.ZPP_CbType.ANY_BODY.zpp_inner
    );
  };
  ...
  nape.phys.Body.prototype.set_type = function (type) {
    ...
    if (zpp_nape.phys.ZPP_Body.types[this.zpp_inner.type] != type) {
      ...
      if (type == zpp_nape.util.ZPP_Flags.BodyType_DYNAMIC) {
        ntype = 2;
      } else {
        if (zpp_nape.util.ZPP_Flags.BodyType_KINEMATIC == null) {
          zpp_nape.util.ZPP_Flags.internal = true;
        ...
        ntype = type == zpp_nape.util.ZPP_Flags.BodyType_KINEMATIC ? 3 : 1;
      }
      if (ntype == 1 && this.zpp_inner.space != null) {
        this.zpp_inner.velx = 0;
        this.zpp_inner.vely = 0;
    ...
    if (
      ...
      if (
        ...
        (this.zpp_inner.compound == null
          ? null
          : this.zpp_inner.compound.outer
        ).zpp_inner.wrap_bodies.remove(this);
      }
      if (compound != null) {
  ...
  nape.phys.Body.prototype.get_arbiters = function () {
    if (this.zpp_inner.wrap_arbiters == null) {
      this.zpp_inner.wrap_arbiters = zpp_nape.util.ZPP_ArbiterList.get(
  ...
  nape.phys.Body.prototype.set_position = function (position) {
    ...
    if (position == null) {
      throw new js._Boot.HaxeError(
        "Error: Body::" + "position" + " cannot be null"
      );
    }
    if (this.zpp_inner.wrap_pos == null) {
      this.zpp_inner.setupPosition();
  ...
  nape.phys.Body.prototype.set_velocity = function (velocity) {
    ...
    if (velocity == null) {
      throw new js._Boot.HaxeError(
        "Error: Body::" + "velocity" + " cannot be null"
      );
    }
    if (this.zpp_inner.wrap_vel == null) {
      this.zpp_inner.setupVelocity();
  ...
  nape.phys.Body.prototype.setVelocityFromTarget = function (
    targetPosition,
    targetRotation,
    deltaTime
  ) {
    ...
    if (deltaTime == 0) {
      throw new js._Boot.HaxeError(
        "deltaTime cannot be 0 for setVelocityFromTarget"
      );
    }
    var idt = 1 / deltaTime;
    if (this.zpp_inner.wrap_vel == null) {
    ...
    if (this.zpp_inner.angvel != angularVel) {
      ...
      if (this.zpp_inner.type == 1) {
        throw new js._Boot.HaxeError(
          "Error: A static object cannot be given a velocity"
        );
      }
  ...
  nape.phys.Body.prototype.set_kinematicVel = function (kinematicVel) {
    ...
    if (kinematicVel == null) {
      throw new js._Boot.HaxeError(
        "Error: Body::" + "kinematicVel" + " cannot be null"
      );
    }
    if (this.zpp_inner.wrap_kinvel == null) {
      this.zpp_inner.setupkinvel();
  ...
  nape.phys.Body.prototype.set_surfaceVel = function (surfaceVel) {
    ...
    if (surfaceVel == null) {
      throw new js._Boot.HaxeError(
        "Error: Body::" + "surfaceVel" + " cannot be null"
      );
    }
    if (this.zpp_inner.wrap_svel == null) {
      this.zpp_inner.setupsvel();
  ...
  nape.phys.Body.prototype.set_force = function (force) {
    ...
    if (force == null) {
      throw new js._Boot.HaxeError(
        "Error: Body::" + "force" + " cannot be null"
      );
    }
    if (this.zpp_inner.wrap_force == null) {
      this.zpp_inner.setupForce();
  ...
  nape.phys.Body.prototype.set_rotation = function (rotation) {
    ...
    if (this.zpp_inner.type == 1 && this.zpp_inner.space != null) {
      throw new js._Boot.HaxeError(
        "Error: Static objects cannot be rotated once inside a Space"
      );
    }
  ...
  nape.phys.Body.prototype.set_torque = function (torque) {
    ...
    if (this.zpp_inner.type != 2) {
      throw new js._Boot.HaxeError(
        "Error: Non-dynamic body cannot have torque applied."
      );
    }
    if (torque != torque) {
  ...
  nape.phys.Body.prototype.get_massMode = function () {
    ...
    var tmp = zpp_nape.util.ZPP_Flags.MassMode_DEFAULT;
    if (zpp_nape.util.ZPP_Flags.MassMode_FIXED == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.MassMode_FIXED = new nape.phys.MassMode();
      zpp_nape.util.ZPP_Flags.internal = false;
    }
    return [tmp, zpp_nape.util.ZPP_Flags.MassMode_FIXED][
      this.zpp_inner.massMode
    ];
  };
  nape.phys.Body.prototype.set_massMode = function (massMode) {
    ...
    this.zpp_inner.massMode =
      massMode == zpp_nape.util.ZPP_Flags.MassMode_DEFAULT ? 0 : 1;
    this.zpp_inner.invalidate_mass();
    if (zpp_nape.util.ZPP_Flags.MassMode_DEFAULT == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.MassMode_DEFAULT = new nape.phys.MassMode();
  ...
  nape.phys.Body.prototype.get_gravMassMode = function () {
    ...
    return [tmp, tmp1, zpp_nape.util.ZPP_Flags.GravMassMode_SCALED][
      this.zpp_inner.massMode
    ];
  };
  nape.phys.Body.prototype.set_gravMassMode = function (gravMassMode) {
    ...
    if (gravMassMode == zpp_nape.util.ZPP_Flags.GravMassMode_SCALED) {
      tmp = 2;
    } else {
      if (zpp_nape.util.ZPP_Flags.GravMassMode_DEFAULT == null) {
        zpp_nape.util.ZPP_Flags.internal = true;
      ...
      tmp =
        gravMassMode == zpp_nape.util.ZPP_Flags.GravMassMode_DEFAULT ? 0 : 1;
    }
    ...
    var tmp1 = zpp_nape.util.ZPP_Flags.GravMassMode_DEFAULT;
    if (zpp_nape.util.ZPP_Flags.GravMassMode_FIXED == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.GravMassMode_FIXED = new nape.phys.GravMassMode();
      zpp_nape.util.ZPP_Flags.internal = false;
    }
    var tmp2 = zpp_nape.util.ZPP_Flags.GravMassMode_FIXED;
    if (zpp_nape.util.ZPP_Flags.GravMassMode_SCALED == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.GravMassMode_SCALED =
        new nape.phys.GravMassMode();
    ...
    return [tmp1, tmp2, zpp_nape.util.ZPP_Flags.GravMassMode_SCALED][
      this.zpp_inner.massMode
    ];
  };
  ...
  nape.phys.Body.prototype.get_inertiaMode = function () {
    ...
    var tmp = zpp_nape.util.ZPP_Flags.InertiaMode_DEFAULT;
    if (zpp_nape.util.ZPP_Flags.InertiaMode_FIXED == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.InertiaMode_FIXED = new nape.phys.InertiaMode();
      zpp_nape.util.ZPP_Flags.internal = false;
    }
    return [tmp, zpp_nape.util.ZPP_Flags.InertiaMode_FIXED][
      this.zpp_inner.inertiaMode
    ];
  };
  nape.phys.Body.prototype.set_inertiaMode = function (inertiaMode) {
    ...
    this.zpp_inner.inertiaMode =
      inertiaMode == zpp_nape.util.ZPP_Flags.InertiaMode_FIXED ? 1 : 0;
    this.zpp_inner.invalidate_inertia();
    if (zpp_nape.util.ZPP_Flags.InertiaMode_DEFAULT == null) {
      zpp_nape.util.ZPP_Flags.internal = true;
      zpp_nape.util.ZPP_Flags.InertiaMode_DEFAULT = new nape.phys.InertiaMode();
  ...
  nape.phys.Body.prototype.get_inertia = function () {
    ...
    this.zpp_inner.validate_inertia();
    var tmp;
    if (this.zpp_inner.inertiaMode == 0) {
      var _this = this.zpp_inner.wrap_shapes;
  ...
  nape.phys.Body.prototype.set_inertia = function (inertia) {
    ...
    if (inertia >= Infinity) {
      throw new js._Boot.HaxeError(
        "Error: Inertia cannot be infinite, use allowRotation = false instead"
      );
    }
  ...
  nape.phys.Body.prototype.interactingBodies = function (type, depth, output) {
    ...
    if (type == null) {
      arbiter_type =
        zpp_nape.dynamics.ZPP_Arbiter.COL |
        zpp_nape.dynamics.ZPP_Arbiter.SENSOR |
        zpp_nape.dynamics.ZPP_Arbiter.FLUID;
    } else {
      ...
      if (type == zpp_nape.util.ZPP_Flags.InteractionType_COLLISION) {
        arbiter_type = zpp_nape.dynamics.ZPP_Arbiter.COL;
      } else {
        ...
        arbiter_type =
          type == zpp_nape.util.ZPP_Flags.InteractionType_SENSOR
            ? zpp_nape.dynamics.ZPP_Arbiter.SENSOR
            : zpp_nape.dynamics.ZPP_Arbiter.FLUID;
      }
    }
  ...
  nape.phys.Body.prototype.crushFactor = function () {
    ...
    while (true) {
      ...
      if (_g.zpp_i < length) {
        ...
        _g.zpp_next = nape.dynamics.ArbiterIterator.zpp_pool;
        nape.dynamics.ArbiterIterator.zpp_pool = _g;
        _g.zpp_inner = null;
        tmp1 = false;
      }
      if (!tmp1) {
      ...
      _g.zpp_critical = false;
      var arb = _g.zpp_inner.at(_g.zpp_i++);
      ...
      var msum2 = msum1 * imp.zpp_inner.x;
      if (imp != null && imp.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
    ...
    var _g1 = nape.constraint.ConstraintIterator.get(_this9);
    while (true) {
      ...
      if (_g1.zpp_i < length1) {
        ...
        _g1.zpp_next = nape.constraint.ConstraintIterator.zpp_pool;
        nape.constraint.ConstraintIterator.zpp_pool = _g1;
        _g1.zpp_inner = null;
        tmp2 = false;
      }
      if (!tmp2) {
      ...
      var con = _g1.zpp_inner.at(_g1.zpp_i++);
      ...
      var msum5 = msum4 * imp1.zpp_inner.x;
      if (imp1 != null && imp1.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
      ...
      msum += Math.sqrt(msum5 + msum6 * imp1.zpp_inner.y);
      if (imp1 != null && imp1.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
    ...
    var ret3 = ret2 * jsum.zpp_inner.x;
    if (jsum != null && jsum.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
    ...
    var ret5 = msum - Math.sqrt(ret3 + ret4 * jsum.zpp_inner.y);
    if (this.zpp_inner.world) {
      throw new js._Boot.HaxeError("Error: Space::world has no mass");
    }
    this.zpp_inner.validate_mass();
  ...
  nape.phys.Body.prototype.localPointToWorld = function (point, weak) {
    ...
    var tempx = 0.0;
    var tempy = 0.0;
    var tempx1 = this.zpp_inner.axisy;
    if (point != null && point.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
    ...
    var tempx2 = tempx1 * point.zpp_inner.x;
    var tempx3 = this.zpp_inner.axisx;
    if (point != null && point.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
    ...
    var tempy1 = point.zpp_inner.x * this.zpp_inner.axisx;
    if (point != null && point.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
  ...
  nape.phys.Body.prototype.localVectorToWorld = function (vector, weak) {
    ...
    var tempx2 = tempx1 * vector.zpp_inner.x;
    var tempx3 = this.zpp_inner.axisx;
    if (vector != null && vector.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
    ...
    var tempy1 = vector.zpp_inner.x * this.zpp_inner.axisx;
    if (vector != null && vector.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
  ...
  nape.phys.Body.prototype.worldVectorToLocal = function (vector, weak) {
    ...
    var tempx1 = vector.zpp_inner.x * this.zpp_inner.axisy;
    if (vector != null && vector.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
    ...
    var tempy1 = vector.zpp_inner.y * this.zpp_inner.axisy;
    if (vector != null && vector.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
      );
  ...
  nape.phys.Body.prototype.applyImpulse = function (impulse, pos, sleepable) {
    ...
    tmp1.velx = tmp2 + impulse.zpp_inner.x * t;
    var tmp3 = this.zpp_inner;
    var tmp4 = tmp3.vely;
    if (impulse != null && impulse.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
    ...
    tmp3.vely = tmp4 + impulse.zpp_inner.y * t;
    if (pos != null) {
      var rx = 0.0;
      var ry = 0.0;
      if (pos != null && pos.zpp_disp) {
      ...
      this.zpp_inner.validate_inertia();
      var tmp5 = this.zpp_inner;
      var tmp6 = tmp5.angvel;
      if (impulse != null && impulse.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
      ...
      var tmp7 = impulse.zpp_inner.y * rx;
      if (impulse != null && impulse.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
      ...
      tmp5.angvel =
        tmp6 + (tmp7 - impulse.zpp_inner.x * ry) * this.zpp_inner.iinertia;
      if (pos.zpp_inner.weak) {
        if (pos != null && pos.zpp_disp) {
          throw new js._Boot.HaxeError(
            "Error: " + "Vec2" + " has been disposed and cannot be used!"
  ...
  nape.phys.Body.prototype.align = function () {
    ...
    if (this.zpp_inner.pre_posx < Infinity) {
      ...
      tmp1.pre_posx = tmp2 - dx2.zpp_inner.x * t;
      var tmp3 = this.zpp_inner;
      var tmp4 = tmp3.pre_posy;
      if (dx2 != null && dx2.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec2" + " has been disposed and cannot be used!"
        );
      ...
      tmp3.pre_posy = tmp4 - dx2.zpp_inner.y * t;
    }
  ...
  nape.phys.Body.prototype.setShapeFluidProperties = function (
    fluidProperties
  ) {
    ...
    while (cx_ite != null) {
      ...
      if (_this.zpp_inner.fluidProperties == null) {
        _this.zpp_inner.setFluid(new nape.phys.FluidProperties().zpp_inner);
      }
  ...
  nape.phys.Body.prototype.get_localCOM = function () {
    ...
    if (this.zpp_inner.wrap_localCOM == null) {
      ...
      this.zpp_inner.wrap_localCOM.zpp_inner._validate =
        (($_ = this.zpp_inner), $bind($_, $_.getlocalCOM));
    }
  ...
  nape.phys.Body.prototype.normalImpulse = function (body, freshOnly) {
    ...
    while (true) {
      ...
      _g.zpp_critical = false;
      var oarb = _g.zpp_inner.at(_g.zpp_i++);
      ...
      if (
        body != null &&
        arb.b2 != body.zpp_inner &&
        arb.b1 != body.zpp_inner
      ) {
        continue;
      }
      var _this = arb.wrapper();
      var imp = (
        _this.zpp_inner.type == zpp_nape.dynamics.ZPP_Arbiter.COL
          ? _this.zpp_inner.colarb.outer_zn
          : null
      ).normalImpulse(this, freshOnly);
      var t = 1;
      var t1 = t;
      if (imp != null && imp.zpp_disp) {
        throw new js._Boot.HaxeError(
          "Error: " + "Vec3" + " has been disposed and cannot be used!"
        );
      }
  ...
  nape.phys.Body.prototype.buoyancyImpulse = function (body) {
    ...
    while (true) {
      ...
      var oarb = _g.zpp_inner.at(_g.zpp_i++);
      var arb = oarb.zpp_inner;
      if (arb.type != zpp_nape.dynamics.ZPP_Arbiter.FLUID) {
        continue;
      }
      if (
        body != null &&
      ...
      var _this = arb.wrapper();
      var imp = (
        _this.zpp_inner.type == zpp_nape.dynamics.ZPP_Arbiter.FLUID
          ? _this.zpp_inner.fluidarb.outer_zn
          : null
      ).buoyancyImpulse(this);
      var t = 1;
      var t1 = t;
      if (imp != null && imp.zpp_disp) {
        throw new js._Boot.HaxeError(
  ...
  nape.phys.Body.prototype.totalImpulse = function (body, freshOnly) {
    ...
    while (true) {
      ...
      var oarb = _g.zpp_inner.at(_g.zpp_i++);
      var arb = oarb.zpp_inner;
      if (arb.type == zpp_nape.dynamics.ZPP_Arbiter.SENSOR) {
        continue;
      }
      if (
        body != null &&
  ...
  nape.phys.Body.prototype.contains = function (point) {
    ...
    if (point == null) {
      throw new js._Boot.HaxeError(
        "Error: Cannot check containment of null point"
      );
    }
  ...
  nape.phys.Body.prototype.toString = function () {
    return (
      (this.zpp_inner.world
        ? "(space::world"
        : "(" +
          (this.zpp_inner.type == 2
            ? "dynamic"
            : this.zpp_inner.type == 1
            ? "static"
            : "kinematic")) +
      ")#" +
      this.zpp_inner_i.id
  ...
  zpp_nape.geom.ZPP_GeomVertexIterator = $hxClasses[
  ...
  zpp_nape.geom.ZPP_GeomVertexIterator.__name__ = [
    "zpp_nape",
    "geom",
    "ZPP_GeomVertexIterator",
  ];
  zpp_nape.geom.ZPP_GeomVertexIterator.get = function (poly, forward) {
    var ret;
    if (zpp_nape.geom.ZPP_GeomVertexIterator.zpp_pool == null) {
      ret = new zpp_nape.geom.ZPP_GeomVertexIterator();
    } else {
  ...
  zpp_nape.geom.ZPP_GeomVertexIterator.prototype.__class__ =
    zpp_nape.geom.ZPP_GeomVertexIterator;
  ...
  zpp_nape.geom.ZPP_MarchingSquares = $hxClasses[
    "zpp_nape.geom.ZPP_MarchingSquares"
  ] = function () {};
  zpp_nape.geom.ZPP_MarchingSquares.__name__ = [
    "zpp_nape",
    "geom",
    "ZPP_MarchingSquares",
  ];
  ...
  zpp_nape.geom.ZPP_MarchingSquares.run = function (
    iso,
    bx0,
    by0,
    bx1,
    ...
    var xp = (bx1 - bx0) / cell.zpp_inner.x;
    var xn = xp | 0;
    if (cell != null && cell.zpp_disp) {
      throw new js._Boot.HaxeError(
        "Error: " + "Vec2" + " has been disposed and cannot be used!"
    ...
    var yp = (by1 - by0) / cell.zpp_inner.y;
    var yn = yp | 0;
    if (xp != xn) {
      ++xn;
    }
    ...
    if (combine) {
      if (zpp_nape.geom.ZPP_MarchingSquares.map == null) {
        zpp_nape.geom.ZPP_MarchingSquares.map =
          new zpp_nape.util.ZNPArray2_ZPP_MarchPair(xn, yn);
      } else {
        zpp_nape.geom.ZPP_MarchingSquares.map.resize(xn, yn, null);
      }
    }
    if (zpp_nape.geom.ZPP_MarchingSquares.isos == null) {
      zpp_nape.geom.ZPP_MarchingSquares.isos =
        new zpp_nape.util.ZNPArray2_Float(xn + 1, yn + 1);
    } else {
      zpp_nape.geom.ZPP_MarchingSquares.isos.resize(xn + 1, yn + 1, 0);
    }
    var _g = 0;
    var _g1 = yn + 1;
    while (_g < _g1) {
      ...
      while (_g2 < _g11) {
        ...
        var _this4 = zpp_nape.geom.ZPP_MarchingSquares.isos;
        var obj = iso(xc, yc);
        _this4.list[y * _this4.width + x] = obj;
      }
    }
    if (zpp_nape.geom.ZPP_MarchingSquares.ints == null) {
      zpp_nape.geom.ZPP_MarchingSquares.ints =
        new zpp_nape.util.ZNPArray2_ZPP_GeomVert(xn + 1, (yn << 1) + 1);
    } else {
      zpp_nape.geom.ZPP_MarchingSquares.ints.resize(
        xn + 1,
        (yn << 1) + 1,
        null
      );
    ...
    var spans = null;
    if (combine) {
      if (zpp_nape.geom.ZPP_MarchSpan.zpp_pool == null) {
        spans = new zpp_nape.geom.ZPP_MarchSpan();
      } else {
    ...
    while (_g21 < _g3) {
      ...
      while (_g22 < _g31) {
        ...
        var pp = zpp_nape.geom.ZPP_MarchingSquares.me.marchSquare(
          iso,
          zpp_nape.geom.ZPP_MarchingSquares.isos,
          zpp_nape.geom.ZPP_MarchingSquares.ints,
          x0,
        ...
        if (combine) {
          ...
          pp.pd =
            ((pd == pp.p2 ? pp.okey2 : pp.okey1) & 128) == 0
              ? pd.prev
              : pd.prev.prev;
          var _this7 = zpp_nape.geom.ZPP_MarchingSquares.map;
          _this7.list[y1 * _this7.width + x1] = pp;
          var tmp;
          if (pre != null) {
            var _this8 = zpp_nape.geom.ZPP_MarchingSquares.me;
            var key = pp.key1;
          ...
          if (tmp) {
            ...
            if (zpp_nape.geom.ZPP_MarchSpan.zpp_pool == null) {
              pp.span1 = new zpp_nape.geom.ZPP_MarchSpan();
            } else {
          ...
          var _this11 = zpp_nape.geom.ZPP_MarchingSquares.me;
          ...
          if (pp.p2 != null) {
            zpp_nape.geom.ZPP_MarchingSquares.me.output(ret, pp.p2);
          }
          var o = pp;
    ...
    while (_g4 < _g5) {
      ...
      while (_g41 < _g51) {
        var x2 = _g41++;
        var _this12 = zpp_nape.geom.ZPP_MarchingSquares.map;
        var b = _this12.list[y2 * _this12.width + x2];
        if (b == null) {
          pre1 = null;
          continue;
        }
        var bkey = b.p2 != null && b.okey2 == 14 ? b.okey2 : b.okey1;
        var _this13 = zpp_nape.geom.ZPP_MarchingSquares.me;
        var flag2 = bkey & 7;
        var cnt2 = 0;
        if ((flag2 & 1) != 0) {
          ++cnt2;
        ...
        var _this14 = zpp_nape.geom.ZPP_MarchingSquares.map;
        var a = _this14.list[(y2 - 1) * _this14.width + x2];
        if (a == null) {
          pre1 = null;
          continue;
        }
        var akey = a.p2 != null && a.okey2 == 56 ? a.okey2 : a.okey1;
        var _this15 = zpp_nape.geom.ZPP_MarchingSquares.me;
        var flag3 = (akey & 112) >> 4;
        var cnt3 = 0;
        if ((flag3 & 1) != 0) {
          ++cnt3;
        }
        ...
        if (tmp1 == tmp2) {
          if (pre1 != bu) {
            zpp_nape.geom.ZPP_MarchingSquares.me.combUD_virtual(a, b);
          }
        } else {
          var xr;
          if (ad == ad.parent) {
        ...
        var key1 = bu == b.span2 ? b.okey2 : b.okey1;
    ...
    while (_g6 < _g7) {
      ...
      while (_g61 < _g71) {
        var x3 = _g61++;
        var _this16 = zpp_nape.geom.ZPP_MarchingSquares.map;
        var p = _this16.list[y3 * _this16.width + x3];
        if (p == null) {
          continue;
        }
        var root;
        ...
        var _this17 = zpp_nape.geom.ZPP_MarchingSquares.map;
        _this17.list[y3 * _this17.width + x3] = null;
      }
    }
    while (spans != null) {
      var t = spans;
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.combLR = function (a, b) {
    ...
    if ((a.keyr & 4) != 0) {
      ...
      if (o.wrap != null) {
        ...
        o1.zpp_pool = null;
        if (zpp_nape.util.ZPP_PubPool.nextVec2 != null) {
          zpp_nape.util.ZPP_PubPool.nextVec2.zpp_pool = o1;
        } else {
          zpp_nape.util.ZPP_PubPool.poolVec2 = o1;
        }
        zpp_nape.util.ZPP_PubPool.nextVec2 = o1;
        o1.zpp_disp = true;
        var o2 = inner;
        if (o2.outer != null) {
          o2.outer.zpp_inner = null;
    ...
    if ((a.keyr & 16) != 0) {
      ...
      if (o6.wrap != null) {
        ...
        o7.zpp_pool = null;
        if (zpp_nape.util.ZPP_PubPool.nextVec2 != null) {
          zpp_nape.util.ZPP_PubPool.nextVec2.zpp_pool = o7;
        } else {
          zpp_nape.util.ZPP_PubPool.poolVec2 = o7;
        }
        ...
        o8._validate = null;
        o8._invalidate = null;
        o8.next = zpp_nape.geom.ZPP_Vec2.zpp_pool;
        zpp_nape.geom.ZPP_Vec2.zpp_pool = o8;
        o6.wrap = null;
      }
    ...
    if (o9.wrap != null) {
      ...
      o10.zpp_pool = null;
      if (zpp_nape.util.ZPP_PubPool.nextVec2 != null) {
        zpp_nape.util.ZPP_PubPool.nextVec2.zpp_pool = o10;
      } else {
        zpp_nape.util.ZPP_PubPool.poolVec2 = o10;
      }
      zpp_nape.util.ZPP_PubPool.nextVec2 = o10;
      o10.zpp_disp = true;
      var o11 = inner3;
      if (o11.outer != null) {
      ...
      o11.next = zpp_nape.geom.ZPP_Vec2.zpp_pool;
      zpp_nape.geom.ZPP_Vec2.zpp_pool = o11;
      o9.wrap = null;
    }
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.marchSquare = function (
    iso,
    isos,
    ints,
    x0,
    ...
    if (key == 0) {
      ...
      var ret;
      if (zpp_nape.geom.ZPP_MarchPair.zpp_pool == null) {
        ret = new zpp_nape.geom.ZPP_MarchPair();
      } else {
      ...
      if (key != 10 && key != 5) {
        ...
        while (_g < 8) {
          ...
          if ((val & (1 << i)) != 0) {
            ...
            if (i == 0) {
              var ret1;
              if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                ret1 = new zpp_nape.geom.ZPP_GeomVert();
              } else {
                ret1 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret1.next;
                ret1.next = null;
              }
              ret1.forced = false;
              ret1.x = x0;
              ...
              var ret2;
              if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                ret2 = new zpp_nape.geom.ZPP_GeomVert();
              } else {
                ret2 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret2.next;
                ret2.next = null;
              }
              ret2.forced = false;
              ret2.x = x1;
              ...
              var ret3;
              if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                ret3 = new zpp_nape.geom.ZPP_GeomVert();
              } else {
                ret3 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret3.next;
                ret3.next = null;
              }
              ret3.forced = false;
              ret3.x = x1;
              ...
              var ret4;
              if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                ret4 = new zpp_nape.geom.ZPP_GeomVert();
              } else {
                ret4 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret4.next;
                ret4.next = null;
              }
              ret4.forced = false;
              ret4.x = x0;
              ...
              if (p == null) {
                ...
                var ret5;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret5 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret5 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret5.next;
                  ret5.next = null;
                }
                ret5.forced = false;
                ret5.x = x;
                ...
                var ret6;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret6 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret6 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret6.next;
                  ret6.next = null;
                }
                ret6.forced = false;
                ret6.x = x2;
              ...
              if (p == null) {
                ...
                var ret7;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret7 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret7 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret7.next;
                  ret7.next = null;
                }
                ret7.forced = false;
                ret7.x = x3;
                ...
                var ret8;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret8 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret8 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret8.next;
                  ret8.next = null;
                }
                ret8.forced = false;
                ret8.x = x4;
              ...
              if (p == null) {
                ...
                var ret9;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret9 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret9 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret9.next;
                  ret9.next = null;
                }
                ret9.forced = false;
                ret9.x = x1;
                ...
                var ret10;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret10 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret10 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret10.next;
                  ret10.next = null;
                }
                ret10.forced = false;
                ret10.x = x5;
              ...
              if (p == null) {
                ...
                var ret11;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret11 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret11 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret11.next;
                  ret11.next = null;
                }
                ret11.forced = false;
                ret11.x = x0;
                ...
                var ret12;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret12 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret12 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret12.next;
                  ret12.next = null;
                }
                ret12.forced = false;
                ret12.x = x6;
            ...
            while (_g1 < 8) {
              ...
              if ((val1 & (1 << i1)) != 0) {
                ...
                if (i1 == 0) {
                  var ret13;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret13 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret13 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret13.next;
                    ret13.next = null;
                  }
                  ret13.forced = false;
                  ret13.x = x0;
                  ...
                  var ret14;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret14 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret14 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret14.next;
                    ret14.next = null;
                  }
                  ret14.forced = false;
                  ret14.x = x1;
                  ...
                  var ret15;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret15 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret15 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret15.next;
                    ret15.next = null;
                  }
                  ret15.forced = false;
                  ret15.x = x1;
                  ...
                  var ret16;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret16 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret16 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret16.next;
                    ret16.next = null;
                  }
                  ret16.forced = false;
                  ret16.x = x0;
                  ...
                  if (p1 == null) {
                    ...
                    var ret17;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret17 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret17 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret17.next;
                      ret17.next = null;
                    }
                    ret17.forced = false;
                    ret17.x = x7;
                    ...
                    var ret18;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret18 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret18 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret18.next;
                      ret18.next = null;
                    }
                    ret18.forced = false;
                    ret18.x = x8;
                  ...
                  if (p1 == null) {
                    ...
                    var ret19;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret19 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret19 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret19.next;
                      ret19.next = null;
                    }
                    ret19.forced = false;
                    ret19.x = x9;
                    ...
                    var ret20;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret20 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret20 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret20.next;
                      ret20.next = null;
                    }
                    ret20.forced = false;
                    ret20.x = x10;
                  ...
                  if (p1 == null) {
                    ...
                    var ret21;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret21 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret21 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret21.next;
                      ret21.next = null;
                    }
                    ret21.forced = false;
                    ret21.x = x1;
                    ...
                    var ret22;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret22 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret22 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret22.next;
                      ret22.next = null;
                    }
                    ret22.forced = false;
                    ret22.x = x11;
                  ...
                  if (p1 == null) {
                    ...
                    var ret23;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret23 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret23 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret23.next;
                      ret23.next = null;
                    }
                    ret23.forced = false;
                    ret23.x = x0;
                    ...
                    var ret24;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret24 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret24 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret24.next;
                      ret24.next = null;
                    }
                    ret24.forced = false;
                    ret24.x = x12;
            ...
            while (_g2 < 8) {
              ...
              if ((val2 & (1 << i2)) != 0) {
                ...
                if (i2 == 0) {
                  var ret25;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret25 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret25 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret25.next;
                    ret25.next = null;
                  }
                  ret25.forced = false;
                  ret25.x = x0;
                  ...
                  var ret26;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret26 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret26 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret26.next;
                    ret26.next = null;
                  }
                  ret26.forced = false;
                  ret26.x = x1;
                  ...
                  var ret27;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret27 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret27 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret27.next;
                    ret27.next = null;
                  }
                  ret27.forced = false;
                  ret27.x = x1;
                  ...
                  var ret28;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret28 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret28 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret28.next;
                    ret28.next = null;
                  }
                  ret28.forced = false;
                  ret28.x = x0;
                  ...
                  if (p2 == null) {
                    ...
                    var ret29;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret29 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret29 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret29.next;
                      ret29.next = null;
                    }
                    ret29.forced = false;
                    ret29.x = x13;
                    ...
                    var ret30;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret30 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret30 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret30.next;
                      ret30.next = null;
                    }
                    ret30.forced = false;
                    ret30.x = x14;
                  ...
                  if (p2 == null) {
                    ...
                    var ret31;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret31 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret31 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret31.next;
                      ret31.next = null;
                    }
                    ret31.forced = false;
                    ret31.x = x15;
                    ...
                    var ret32;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret32 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret32 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret32.next;
                      ret32.next = null;
                    }
                    ret32.forced = false;
                    ret32.x = x16;
                  ...
                  if (p2 == null) {
                    ...
                    var ret33;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret33 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret33 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret33.next;
                      ret33.next = null;
                    }
                    ret33.forced = false;
                    ret33.x = x1;
                    ...
                    var ret34;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret34 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret34 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret34.next;
                      ret34.next = null;
                    }
                    ret34.forced = false;
                    ret34.x = x17;
                  ...
                  if (p2 == null) {
                    ...
                    var ret35;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret35 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret35 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret35.next;
                      ret35.next = null;
                    }
                    ret35.forced = false;
                    ret35.x = x0;
                    ...
                    var ret36;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret36 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret36 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret36.next;
                      ret36.next = null;
                    }
                    ret36.forced = false;
                    ret36.x = x18;
              ...
              while (_g3 < 8) {
                ...
                if ((val3 & (1 << i3)) != 0) {
                  ...
                  if (i3 == 0) {
                    var ret37;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret37 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret37 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret37.next;
                      ret37.next = null;
                    }
                    ret37.forced = false;
                    ret37.x = x0;
                    ...
                    var ret38;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret38 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret38 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret38.next;
                      ret38.next = null;
                    }
                    ret38.forced = false;
                    ret38.x = x1;
                    ...
                    var ret39;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret39 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret39 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret39.next;
                      ret39.next = null;
                    }
                    ret39.forced = false;
                    ret39.x = x1;
                    ...
                    var ret40;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret40 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret40 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret40.next;
                      ret40.next = null;
                    }
                    ret40.forced = false;
                    ret40.x = x0;
                    ...
                    if (p3 == null) {
                      ...
                      var ret41;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret41 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret41 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret41.next;
                        ret41.next = null;
                      }
                      ret41.forced = false;
                      ret41.x = x19;
                      ...
                      var ret42;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret42 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret42 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret42.next;
                        ret42.next = null;
                      }
                      ret42.forced = false;
                      ret42.x = x20;
                    ...
                    if (p3 == null) {
                      ...
                      var ret43;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret43 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret43 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret43.next;
                        ret43.next = null;
                      }
                      ret43.forced = false;
                      ret43.x = x21;
                      ...
                      var ret44;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret44 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret44 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret44.next;
                        ret44.next = null;
                      }
                      ret44.forced = false;
                      ret44.x = x22;
                    ...
                    if (p3 == null) {
                      ...
                      var ret45;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret45 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret45 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret45.next;
                        ret45.next = null;
                      }
                      ret45.forced = false;
                      ret45.x = x1;
                      ...
                      var ret46;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret46 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret46 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret46.next;
                        ret46.next = null;
                      }
                      ret46.forced = false;
                      ret46.x = x23;
                    ...
                    if (p3 == null) {
                      ...
                      var ret47;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret47 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret47 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret47.next;
                        ret47.next = null;
                      }
                      ret47.forced = false;
                      ret47.x = x0;
                      ...
                      var ret48;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret48 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret48 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret48.next;
                        ret48.next = null;
                      }
                      ret48.forced = false;
                      ret48.x = x24;
              ...
              while (_g4 < 8) {
                ...
                if ((val4 & (1 << i4)) != 0) {
                  ...
                  if (i4 == 0) {
                    var ret49;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret49 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret49 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret49.next;
                      ret49.next = null;
                    }
                    ret49.forced = false;
                    ret49.x = x0;
                    ...
                    var ret50;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret50 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret50 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret50.next;
                      ret50.next = null;
                    }
                    ret50.forced = false;
                    ret50.x = x1;
                    ...
                    var ret51;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret51 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret51 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret51.next;
                      ret51.next = null;
                    }
                    ret51.forced = false;
                    ret51.x = x1;
                    ...
                    var ret52;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret52 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret52 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret52.next;
                      ret52.next = null;
                    }
                    ret52.forced = false;
                    ret52.x = x0;
                    ...
                    if (p4 == null) {
                      ...
                      var ret53;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret53 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret53 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret53.next;
                        ret53.next = null;
                      }
                      ret53.forced = false;
                      ret53.x = x25;
                      ...
                      var ret54;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret54 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret54 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret54.next;
                        ret54.next = null;
                      }
                      ret54.forced = false;
                      ret54.x = x26;
                    ...
                    if (p4 == null) {
                      ...
                      var ret55;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret55 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret55 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret55.next;
                        ret55.next = null;
                      }
                      ret55.forced = false;
                      ret55.x = x27;
                      ...
                      var ret56;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret56 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret56 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret56.next;
                        ret56.next = null;
                      }
                      ret56.forced = false;
                      ret56.x = x28;
                    ...
                    if (p4 == null) {
                      ...
                      var ret57;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret57 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret57 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret57.next;
                        ret57.next = null;
                      }
                      ret57.forced = false;
                      ret57.x = x1;
                      ...
                      var ret58;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret58 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret58 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret58.next;
                        ret58.next = null;
                      }
                      ret58.forced = false;
                      ret58.x = x29;
                    ...
                    if (p4 == null) {
                      ...
                      var ret59;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret59 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret59 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret59.next;
                        ret59.next = null;
                      }
                      ret59.forced = false;
                      ret59.x = x0;
                      ...
                      var ret60;
                      if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                        ret60 = new zpp_nape.geom.ZPP_GeomVert();
                      } else {
                        ret60 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                        zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret60.next;
                        ret60.next = null;
                      }
                      ret60.forced = false;
                      ret60.x = x30;
          ...
          while (_g5 < 8) {
            ...
            if ((val5 & (1 << i5)) != 0) {
              ...
              if (i5 == 0) {
                var ret61;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret61 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret61 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret61.next;
                  ret61.next = null;
                }
                ret61.forced = false;
                ret61.x = x0;
                ...
                var ret62;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret62 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret62 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret62.next;
                  ret62.next = null;
                }
                ret62.forced = false;
                ret62.x = x1;
                ...
                var ret63;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret63 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret63 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret63.next;
                  ret63.next = null;
                }
                ret63.forced = false;
                ret63.x = x1;
                ...
                var ret64;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret64 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret64 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret64.next;
                  ret64.next = null;
                }
                ret64.forced = false;
                ret64.x = x0;
                ...
                if (p5 == null) {
                  ...
                  var ret65;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret65 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret65 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret65.next;
                    ret65.next = null;
                  }
                  ret65.forced = false;
                  ret65.x = x31;
                  ...
                  var ret66;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret66 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret66 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret66.next;
                    ret66.next = null;
                  }
                  ret66.forced = false;
                  ret66.x = x32;
                ...
                if (p5 == null) {
                  ...
                  var ret67;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret67 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret67 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret67.next;
                    ret67.next = null;
                  }
                  ret67.forced = false;
                  ret67.x = x33;
                  ...
                  var ret68;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret68 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret68 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret68.next;
                    ret68.next = null;
                  }
                  ret68.forced = false;
                  ret68.x = x34;
                ...
                if (p5 == null) {
                  ...
                  var ret69;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret69 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret69 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret69.next;
                    ret69.next = null;
                  }
                  ret69.forced = false;
                  ret69.x = x1;
                  ...
                  var ret70;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret70 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret70 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret70.next;
                    ret70.next = null;
                  }
                  ret70.forced = false;
                  ret70.x = x35;
                ...
                if (p5 == null) {
                  ...
                  var ret71;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret71 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret71 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret71.next;
                    ret71.next = null;
                  }
                  ret71.forced = false;
                  ret71.x = x0;
                  ...
                  var ret72;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret72 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret72 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret72.next;
                    ret72.next = null;
                  }
                  ret72.forced = false;
                  ret72.x = x36;
          ...
          while (_g6 < 8) {
            ...
            if ((val6 & (1 << i6)) != 0) {
              ...
              if (i6 == 0) {
                var ret73;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret73 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret73 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret73.next;
                  ret73.next = null;
                }
                ret73.forced = false;
                ret73.x = x0;
                ...
                var ret74;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret74 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret74 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret74.next;
                  ret74.next = null;
                }
                ret74.forced = false;
                ret74.x = x1;
                ...
                var ret75;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret75 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret75 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret75.next;
                  ret75.next = null;
                }
                ret75.forced = false;
                ret75.x = x1;
                ...
                var ret76;
                if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                  ret76 = new zpp_nape.geom.ZPP_GeomVert();
                } else {
                  ret76 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                  zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret76.next;
                  ret76.next = null;
                }
                ret76.forced = false;
                ret76.x = x0;
                ...
                if (p6 == null) {
                  ...
                  var ret77;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret77 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret77 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret77.next;
                    ret77.next = null;
                  }
                  ret77.forced = false;
                  ret77.x = x37;
                  ...
                  var ret78;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret78 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret78 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret78.next;
                    ret78.next = null;
                  }
                  ret78.forced = false;
                  ret78.x = x38;
                ...
                if (p6 == null) {
                  ...
                  var ret79;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret79 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret79 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret79.next;
                    ret79.next = null;
                  }
                  ret79.forced = false;
                  ret79.x = x39;
                  ...
                  var ret80;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret80 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret80 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret80.next;
                    ret80.next = null;
                  }
                  ret80.forced = false;
                  ret80.x = x40;
                ...
                if (p6 == null) {
                  ...
                  var ret81;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret81 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret81 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret81.next;
                    ret81.next = null;
                  }
                  ret81.forced = false;
                  ret81.x = x1;
                  ...
                  var ret82;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret82 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret82 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret82.next;
                    ret82.next = null;
                  }
                  ret82.forced = false;
                  ret82.x = x41;
                ...
                if (p6 == null) {
                  ...
                  var ret83;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret83 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret83 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret83.next;
                    ret83.next = null;
                  }
                  ret83.forced = false;
                  ret83.x = x0;
                  ...
                  var ret84;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret84 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret84 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret84.next;
                    ret84.next = null;
                  }
                  ret84.forced = false;
                  ret84.x = x42;
            ...
            while (_g7 < 8) {
              ...
              if ((val7 & (1 << i7)) != 0) {
                ...
                if (i7 == 0) {
                  var ret85;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret85 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret85 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret85.next;
                    ret85.next = null;
                  }
                  ret85.forced = false;
                  ret85.x = x0;
                  ...
                  var ret86;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret86 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret86 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret86.next;
                    ret86.next = null;
                  }
                  ret86.forced = false;
                  ret86.x = x1;
                  ...
                  var ret87;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret87 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret87 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret87.next;
                    ret87.next = null;
                  }
                  ret87.forced = false;
                  ret87.x = x1;
                  ...
                  var ret88;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret88 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret88 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret88.next;
                    ret88.next = null;
                  }
                  ret88.forced = false;
                  ret88.x = x0;
                  ...
                  if (p7 == null) {
                    ...
                    var ret89;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret89 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret89 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret89.next;
                      ret89.next = null;
                    }
                    ret89.forced = false;
                    ret89.x = x43;
                    ...
                    var ret90;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret90 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret90 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret90.next;
                      ret90.next = null;
                    }
                    ret90.forced = false;
                    ret90.x = x44;
                  ...
                  if (p7 == null) {
                    ...
                    var ret91;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret91 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret91 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret91.next;
                      ret91.next = null;
                    }
                    ret91.forced = false;
                    ret91.x = x45;
                    ...
                    var ret92;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret92 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret92 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret92.next;
                      ret92.next = null;
                    }
                    ret92.forced = false;
                    ret92.x = x46;
                  ...
                  if (p7 == null) {
                    ...
                    var ret93;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret93 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret93 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret93.next;
                      ret93.next = null;
                    }
                    ret93.forced = false;
                    ret93.x = x1;
                    ...
                    var ret94;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret94 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret94 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret94.next;
                      ret94.next = null;
                    }
                    ret94.forced = false;
                    ret94.x = x47;
                  ...
                  if (p7 == null) {
                    ...
                    var ret95;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret95 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret95 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret95.next;
                      ret95.next = null;
                    }
                    ret95.forced = false;
                    ret95.x = x0;
                    ...
                    var ret96;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret96 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret96 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret96.next;
                      ret96.next = null;
                    }
                    ret96.forced = false;
                    ret96.x = x48;
            ...
            while (_g8 < 8) {
              ...
              if ((val8 & (1 << i8)) != 0) {
                ...
                if (i8 == 0) {
                  var ret97;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret97 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret97 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret97.next;
                    ret97.next = null;
                  }
                  ret97.forced = false;
                  ret97.x = x0;
                  ...
                  var ret98;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret98 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret98 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret98.next;
                    ret98.next = null;
                  }
                  ret98.forced = false;
                  ret98.x = x1;
                  ...
                  var ret99;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret99 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret99 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret99.next;
                    ret99.next = null;
                  }
                  ret99.forced = false;
                  ret99.x = x1;
                  ...
                  var ret100;
                  if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                    ret100 = new zpp_nape.geom.ZPP_GeomVert();
                  } else {
                    ret100 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                    zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret100.next;
                    ret100.next = null;
                  }
                  ret100.forced = false;
                  ret100.x = x0;
                  ...
                  if (p8 == null) {
                    ...
                    var ret101;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret101 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret101 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret101.next;
                      ret101.next = null;
                    }
                    ret101.forced = false;
                    ret101.x = x49;
                    ...
                    var ret102;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret102 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret102 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret102.next;
                      ret102.next = null;
                    }
                    ret102.forced = false;
                    ret102.x = x50;
                  ...
                  if (p8 == null) {
                    ...
                    var ret103;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret103 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret103 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret103.next;
                      ret103.next = null;
                    }
                    ret103.forced = false;
                    ret103.x = x51;
                    ...
                    var ret104;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret104 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret104 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret104.next;
                      ret104.next = null;
                    }
                    ret104.forced = false;
                    ret104.x = x52;
                  ...
                  if (p8 == null) {
                    ...
                    var ret105;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret105 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret105 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret105.next;
                      ret105.next = null;
                    }
                    ret105.forced = false;
                    ret105.x = x1;
                    ...
                    var ret106;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret106 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret106 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret106.next;
                      ret106.next = null;
                    }
                    ret106.forced = false;
                    ret106.x = x53;
                  ...
                  if (p8 == null) {
                    ...
                    var ret107;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret107 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret107 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret107.next;
                      ret107.next = null;
                    }
                    ret107.forced = false;
                    ret107.x = x0;
                    ...
                    var ret108;
                    if (zpp_nape.geom.ZPP_GeomVert.zpp_pool == null) {
                      ret108 = new zpp_nape.geom.ZPP_GeomVert();
                    } else {
                      ret108 = zpp_nape.geom.ZPP_GeomVert.zpp_pool;
                      zpp_nape.geom.ZPP_GeomVert.zpp_pool = ret108.next;
                      ret108.next = null;
                    }
                    ret108.forced = false;
                    ret108.x = x54;
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.lerp = function (x0, x1, v0, v1) {
    if (v0 == 0) {
      ...
      var dv = v0 - v1;
      var t =
        dv * dv < nape.Config.epsilon * nape.Config.epsilon ? 0.5 : v0 / dv;
      if (t < 0) {
        t = 0;
      } else if (t > 1) {
        t = 1;
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.xlerp = function (
    x0,
    x1,
    y,
    v0,
    ...
    while (quality-- != 0 && x0 < xm && xm < x1) {
      ...
      if (v0 == 0) {
        ...
        var dv1 = v0 - v1;
        var t1 =
          dv1 * dv1 < nape.Config.epsilon * nape.Config.epsilon
            ? 0.5
            : v0 / dv1;
        if (t1 < 0) {
          t1 = 0;
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.ylerp = function (
    y0,
    y1,
    x,
    v0,
  ...
  zpp_nape.geom.ZPP_MarchingSquares.prototype.__class__ =
    zpp_nape.geom.ZPP_MarchingSquares;
  ...
  zpp_nape.geom.ZPP_ToiEvent = $hxClasses["zpp_nape.geom.ZPP_ToiEvent"] =
    function () {
  ...
  zpp_nape.phys.ZPP_Interactor = $hxClasses["zpp_nape.phys.ZPP_Interactor"] =
    function () {
  ...
  zpp_nape.phys.ZPP_Interactor.__name__ = [
    "zpp_nape",
    "phys",
    "ZPP_Interactor",
  ];
  ...
  zpp_nape.phys.ZPP_Interactor.prototype.copyto = function (ret) {
    ...
    _this1.zpp_inner.valmod();
    var _g = nape.callbacks.CbTypeIterator.get(_this1);
    while (true) {
      _g.zpp_inner.zpp_inner.valmod();
  ...
  zpp_nape.util.ZPP_Vec2List = $hxClasses["zpp_nape.util.ZPP_Vec2List"] =
    function () {
      this.user_length = 0;
      this.zip_length = false;
      this.push_ite = null;
  ...
  zpp_nape.util.ZPP_ContactList = $hxClasses["zpp_nape.util.ZPP_ContactList"] =
    function () {
      this.user_length = 0;
      this.zip_length = false;
      this.push_ite = null;
  ...
  zpp_nape.util.ZPP_ContactList.__name__ = [
    "zpp_nape",
    "util",
    "ZPP_ContactList",
  ];
  ...
  zpp_nape.util.ZPP_ContactList.prototype.__class__ =
