...
import { ZNPArray2_Float, ZNPArray2_ZPP_GeomVert, ZNPArray2_ZPP_MarchPair } from "../native/util/ZNPArray2";
import { Hashable2_Boolfalse as Hashable2_Boolfalse_TS } from "../native/util/Hashable2_Boolfalse";
import { FastHash2_Hashable2_Boolfalse as FastHash2_Hashable2_Boolfalse_TS } from "../native/util/FastHash2_Hashable2_Boolfalse";
...
define(function () {
  ...
  // =========================================================================
  // Generic ZNPNode factory — creates named subclasses of ZNPNode_Base (TS)
  // All method logic lives in src/native/util/ZNPNode.ts
  // =========================================================================
  function createZNPNode(typeName) {
    var cls = class extends ZNPNode_Base {};
  ...
  // =========================================================================
  // Generic ZNPList factory — creates named subclasses of ZNPList_Base (TS)
  // All method logic lives in src/native/util/ZNPList.ts
  // =========================================================================
  function createZNPList(typeName, N) {
    var cls = class extends ZNPList_Base {};
  ...
  // =========================================================================
  // Generic ZPP_Set factory — creates named subclasses of ZPP_Set_Base (TS)
  // All method logic lives in src/native/util/ZPP_Set.ts
  // =========================================================================
  function createZPPSet(typeName) {
    var cls = class extends ZPP_Set_Base {};
  ...
  // ZNPArray2_Float, ZNPArray2_ZPP_GeomVert, ZNPArray2_ZPP_MarchPair: converted to TypeScript → src/native/util/ZNPArray2.ts
  ...
  // Hashable2_Boolfalse: converted to TypeScript → src/native/util/Hashable2_Boolfalse.ts
  zpp_nape.util.Hashable2_Boolfalse = Hashable2_Boolfalse_TS;
  // FastHash2_Hashable2_Boolfalse: converted to TypeScript → src/native/util/FastHash2_Hashable2_Boolfalse.ts
  zpp_nape.util.FastHash2_Hashable2_Boolfalse = FastHash2_Hashable2_Boolfalse_TS;
  ...
  // ZPP_MixVec2List: converted to TypeScript → src/native/util/ZPP_MixVec2List.ts
  // Registration handled by ZPP_MixVec2List.ts at module load time via engine.ts.
  // ZPP_ConstraintList … ZPP_ArbiterList: converted to TypeScript → src/native/util/ZPP_PublicList.ts
  // Registration handled by ZPP_PublicList.ts at module load time.
  ...
  // Public API static flags (zpp_internalAlloc, zpp_pool): set on stubs, re-set by TS at module load
  // ZPP_Const/ZPP_ID/ZPP_Callback/ZPP_CbSet statics: initialized in native TypeScript
  // CbType ANY_* singletons: migrated to ZPP_CbType._initEnums()
  zpp_nape.callbacks.ZPP_CbType._initEnums(nape);
  // ZPP_Flags.internal + id_* constants: initialized as static fields in ZPP_Flags.ts
  // ListenerType + CbEvent singletons: migrated to ZPP_Listener._initEnums()
  zpp_nape.callbacks.ZPP_Listener._initEnums(nape, zpp_nape.util.ZPP_Flags);
  // ZPP_InteractionListener working lists: migrated to _initStatics()
  zpp_nape.callbacks.ZPP_InteractionListener._initStatics(zpp_nape);
  // ArbiterType singletons: migrated to ZPP_Arbiter._initEnums()
  zpp_nape.dynamics.ZPP_Arbiter._initEnums(nape, zpp_nape.util.ZPP_Flags);
  // Static object inits: migrated to respective _initStatics() methods
  zpp_nape.geom.ZPP_Collide._initStatics(zpp_nape);
  // ZPP_MarchingSquares.me + look_march: initialized in _init() above
  // BodyType singletons: migrated to ZPP_Body._initEnums()
  zpp_nape.phys.ZPP_Body._initEnums(nape, zpp_nape.util.ZPP_Flags);
  // ZPP_Body/ZPP_FluidProperties/ZPP_Material pools/constants: initialized in TS static fields
  // ShapeType singletons: migrated to ZPP_Shape._initEnums()
  zpp_nape.shape.ZPP_Shape._initEnums(nape, zpp_nape.util.ZPP_Flags);
  // Pool/constant statics for ZPP_Edge, ZPP_Space, ZNPNode, ZNPList, ZPP_Set: initialized in TS static fields
