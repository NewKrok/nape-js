...
// ZNPNode / ZNPList / ZPP_Set base classes: used only by ZNPRegistry.ts (no longer imported here)
import { registerZNPClasses } from "../native/util/ZNPRegistry";
...
define(function () {
  ...
  // ZNPNode / ZNPList / ZPP_Set classes: moved to TypeScript → src/native/util/ZNPRegistry.ts
  registerZNPClasses(zpp_nape, $hxClasses);
  ...
  // ZNPNode / ZNPList / ZPP_Set classes (78 total): registered by registerZNPClasses() above → see src/native/util/ZNPRegistry.ts
