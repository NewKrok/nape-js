 ...
 */
import { VERSION } from "./nape-js.esm.js?v=3.40.0";
import { installErrorOverlay } from "./renderer.js?v=3.40.0";
import { DemoRunner } from "./demo-runner.js?v=3.40.0";
import { Canvas2DAdapter } from "./renderers/canvas2d-adapter.js?v=3.40.0";
import { ThreeJSAdapter, loadThree } from "./renderers/threejs-adapter.js?v=3.40.0";
import { PixiJSAdapter, loadPixi } from "./renderers/pixijs-adapter.js?v=3.40.0";
import { openInCodePen as _openInCodePen, getPreviewCode } from "./codepen-templates.js?v=3.40.0";
import { openInStackBlitz as _openInStackBlitz } from "./stackblitz-templates.js?v=3.40.0";
import { CATEGORIES, categoryOf } from "./demo-categories.js?v=3.40.0";
import { t as i18n } from "./i18n/i18n.js?v=3.40.0";
...
// All demos
import falling     from "./demos/falling.js?v=3.40.0";
import pyramid     from "./demos/pyramid.js?v=3.40.0";
import chain       from "./demos/chain.js?v=3.40.0";
import explosion   from "./demos/explosion.js?v=3.40.0";
import constraints from "./demos/constraints.js?v=3.40.0";
import gravity     from "./demos/gravity.js?v=3.40.0";
import stacking    from "./demos/stacking.js?v=3.40.0";
import ragdoll     from "./demos/ragdoll.js?v=3.40.0";
import strandbeast from "./demos/strandbeast.js?v=3.40.0";
import carSideview    from "./demos/car-sideview.js?v=3.40.0";
import trackedVehicle from "./demos/tracked-vehicle.js?v=3.40.0";
import carTopdown     from "./demos/car-topdown.js?v=3.40.0";
import ropeBridge     from "./demos/rope-bridge.js?v=3.40.0";
import wreckingBall   from "./demos/wrecking-ball.js?v=3.40.0";
import newtonsCradle  from "./demos/newtons-cradle.js?v=3.40.0";
import dominos        from "./demos/dominos.js?v=3.40.0";
import conveyorBelts  from "./demos/conveyor-belts.js?v=3.40.0";
import trebuchet      from "./demos/trebuchet.js?v=3.40.0";
import seesaw         from "./demos/seesaw.js?v=3.40.0";
import pinball        from "./demos/pinball.js?v=3.40.0";
import cloth          from "./demos/cloth.js?v=3.40.0";
import funnel         from "./demos/funnel.js?v=3.40.0";
import softBody       from "./demos/soft-body.js?v=3.40.0";
import oneWayPlatforms from "./demos/one-way-platforms.js?v=3.40.0";
import filteringInteractions from "./demos/filtering-interactions.js?v=3.40.0";
import bodyFromGraphic    from "./demos/body-from-graphic.js?v=3.40.0";
import dropImageBody     from "./demos/drop-image-body.js?v=3.40.0";
import capsule           from "./demos/capsule.js?v=3.40.0";
import destructibleTerrain from "./demos/destructible-terrain.js?v=3.40.0";
import webWorker           from "./demos/web-worker.js?v=3.40.0";
import asteroidField       from "./demos/asteroid-field.js?v=3.40.0";
import fluidBuoyancy       from "./demos/fluid-buoyancy.js?v=3.40.0";
import deterministic       from "./demos/deterministic.js?v=3.40.0";
import subStepping         from "./demos/sub-stepping.js?v=3.40.0";
import characterController from "./demos/character-controller.js?v=3.40.0";
import triggerZones        from "./demos/trigger-zones.js?v=3.40.0";
import fracture            from "./demos/fracture.js?v=3.40.0";
import slingshot           from "./demos/slingshot.js?v=3.40.0";
import springJoint         from "./demos/spring-joint.js?v=3.40.0";
import portals             from "./demos/portals.js?v=3.40.0";
import towerDefense        from "./demos/tower-defense.js?v=3.40.0";
import topDownShooter      from "./demos/top-down-shooter.js?v=3.40.0";
import mobaLite            from "./demos/moba-lite.js?v=3.40.0";
import plinko              from "./demos/plinko.js?v=3.40.0";
import threeBody           from "./demos/three-body.js?v=3.40.0";
import tilemap             from "./demos/tilemap.js?v=3.40.0";
import planetPlatformer    from "./demos/planet-platformer.js?v=3.40.0";
import volcano             from "./demos/volcano.js?v=3.40.0";
import destructibleArena   from "./demos/destructible-arena.js?v=3.40.0";
import arenaDefense        from "./demos/arena-defense.js?v=3.40.0";
import saveLoadRewind      from "./demos/save-load-rewind.js?v=3.40.0";
import replayRecorder      from "./demos/replay-recorder.js?v=3.40.0";
import popcorn             from "./demos/popcorn.js?v=3.40.0";
import rollercoaster       from "./demos/rollercoaster.js?v=3.40.0";
import convexCast          from "./demos/convex-cast.js?v=3.40.0";
import floppyFists         from "./demos/floppy-fists.js?v=3.40.0";
import minigolf             from "./demos/minigolf.js?v=3.40.0";
import wyrm                 from "./demos/wyrm.js?v=3.40.0";
import brickline            from "./demos/brickline.js?v=3.40.0";
import pulleyCrane          from "./demos/pulley-crane.js?v=3.40.0";
import tinywheelsCup        from "./demos/tinywheels-cup.js?v=3.40.0";
import tiltrun               from "./demos/tiltrun.js?v=3.40.0";
import dirtline              from "./demos/dirtline.js?v=3.40.0";
import explodingFifty        from "./demos/exploding-50.js?v=3.40.0";
import billiards             from "./demos/billiards.js?v=3.40.0";
import standoff              from "./demos/standoff.js?v=3.40.0";
import stickyBuilder         from "./demos/sticky-builder.js?v=3.40.0";
import contraptionGarage     from "./demos/contraption-garage.js?v=3.40.0";
import crashTestHero         from "./demos/crash-test-hero.js?v=3.40.0";
import raftRapids            from "./demos/raft-rapids.js?v=3.40.0";
import skyHook               from "./demos/sky-hook.js?v=3.40.0";
import ragdollRoyale         from "./demos/ragdoll-royale.js?v=3.40.0";
...
import captureTheFlag        from "./demos/capture-the-flag.js?v=3.40.0";
