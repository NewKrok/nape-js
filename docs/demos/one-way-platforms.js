import { Body, BodyType, Vec2, Polygon, CbType, InteractionType, PreListener, PreFlag, PivotJoint } from "../nape-js.esm.js?v=3.42.1";
import { spawnRandomShape } from "../demo-runner.js?v=3.42.1";
